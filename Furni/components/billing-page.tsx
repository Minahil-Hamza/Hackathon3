            ...
            <div className="mt-10 bg-white p-4 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <nav className="flex items-center gap-2 py-3.5">
                        ...
                        <span className="text-sm text-[#8B4513]">Checkout</span>
                    </nav>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="border rounded-sm p-4 sm:p-6 space-y-4 w-full bg-white shadow-sm">
                        <h2 className="text-lg sm:text-xl font-medium mb-4 text-[#8B4513]">Order Summary</h2>
                        {cartItems.map((item) => (
                    ...
                    {/* Billing Form */}
                    <div className="border rounded-sm p-4 sm:p-6 space-y-4 w-full bg-white shadow-sm">
                        <h2 className="text-xl sm:text-2xl font-medium mb-6 text-[#8B4513]">Billing Information</h2>
                        ...
                        <div className="flex gap-2 mt-4">
                            ...
                            />
                            <Button 
                                className="bg-[#8B4513] hover:bg-[#6B4514] text-white"
