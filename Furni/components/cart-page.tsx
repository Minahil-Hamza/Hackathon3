...
//     // useEffect(() => {
//     //     if (!isSignedIn || user?.primaryEmailAddress?.emailAddress !== "subhankaladi@gmail.com") {
//     //       routerr.replace("/"); // `replace` use karna better hai
//     //     } else {
//     //       setIsLoading(false); // User authenticated, stop loading
//     //     }
//     //   }, [isSignedIn, user, routerr]);
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Button 
                                ...
                                className="h-10 sm:h-12 px-6 sm:px-8 bg-[#8B4513] hover:bg-[#6B4513] rounded-lg w-full sm:w-auto"
                            >
                                Apply Coupon
                            </Button>
                        </div>
                        ...
                        <div className="border rounded-lg p-4 sm:p-6 space-y-4 w-full lg:max-w-[470px] lg:ml-auto bg-white">
                            ...
                            <Button 
                                onClick={() => router.push('/checkout')}
                                className="w-full h-10 sm:h-12 bg-[#8B4513]  hover:bg-[#6B4513] rounded-lg mt-4 text-sm sm:text-base"
                            >
                                Proceed to checkout
                            </Button>
                        </div>
